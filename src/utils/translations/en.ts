...
export const enTranslations: TranslationKeys = {
  ...
  error: "Error",
  invoiceNotFound: "Record Not Found",
  invoiceUpdated: "Record Updated",
  invoiceSuccessfullyUpdated: "Record Successfully Updated",
  errorUpdatingInvoice: "Error Updating Record",
  couldNotUpdateInvoice: "Could Not Update Record",
  back: "BACK",
  editInvoice: "EDIT RECORD",
  updateInvoiceInfo: "UPDATE RECORD INFO",
  documentPreview: "DOCUMENT PREVIEW",
  viewOriginalDocument: "View Original Document",
  openOriginalDocument: "OPEN ORIGINAL DOCUMENT",
  editInvoiceDetails: "EDIT RECORD DETAILS",
  updateInvoiceInfoNeeded: "UPDATE RECORD INFO NEEDED",
  updateInvoice: "UPDATE RECORD",
